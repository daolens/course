    ...
    <div className="min-h-screen px-4 w-full flex flex-col items-center bg-white bg-opacity-95 text-black">
      <motion.div className="w-full h-screen md:w-1/3 flex flex-col justify-center gap-4">
        <div>
          ...
          fugit cupiditate quisquam vero nostrum iste praesentium quam laborum
          esse ipsa!
        </div>
        <AnimatePresence>
          {curr == 0 && (
      ...
      <Slide curr={curr} setCurr={setCurr} idx={1}>
        <>
      ...
      <Slide curr={curr} setCurr={setCurr} idx={2}>
        <>
          <div>
      ...
      <Slide curr={curr} setCurr={setCurr} idx={3}>
        <div>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti
          rerum cum porro.
        </div>
